...
CREATE TABLE `board` (
  ...
  `boardCreationDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE `workspace` (
  ...
  `workspaceCreationDate` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
